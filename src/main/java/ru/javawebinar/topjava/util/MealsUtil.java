...
public class MealsUtil {
    ...
    public static List<MealTo> getFilteredToSDT(Collection<Meal> meals, int caloriesPerDay, LocalDateTime start,
                                                     LocalDateTime end) {
        return filterByPredicate(meals, caloriesPerDay,
                meal -> DateTimeUtil.isBetweenDateTime(meal.getDateTime(), start, end));
    }
